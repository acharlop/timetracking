proj1 = Project.create! name: "Ironhack", description: "Ironhack is awesome!"
Project.create! name: "Time tracking app"
Project.create! name: "Recipes", description: "Track my favorite recipes"
TimeEntry.create! project: proj1, hours: 1, minutes: 0, comment: "Did some awesome stuff", date: Time.now - 5.hours
